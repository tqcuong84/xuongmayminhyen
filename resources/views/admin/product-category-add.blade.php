...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.product.category.postAdd') }}" method="POST">
                @csrf
            <div class="row">
                @if ($result == 'success')
                <div class="col-md-12">
                    <div class="alert alert-success text-center " role="alert">
                        Thông tin danh mục sản phẩm đã được tạo thành công
                    </div>
                </div>
                @elseif ($errors->any())
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="name_seo" class="form-control" value="{{old('name_seo')}}" placeholder="">
                            </div>
                            <div class="form-group">
