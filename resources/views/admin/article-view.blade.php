            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="alert alert-success text-center " role="alert">
                        Thông tin bài viết đã được lưu thành công
                    </div>
                </div>
                @endif
                <div class="col-md-8">
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="content" id="editor_content">{{$article->content}}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title_seo" class="form-control" value="{{$article->title_seo}}" placeholder="">
                            </div>
                            <div class="form-group">
                                <label>Meta description</label>
                                <textarea class="form-control" name="description_seo">{{$article->description_seo}}</textarea>
                            </div>
                            <div class="form-group">
                                <label>Meta keyword</label>
                                <textarea class="form-control" name="keyword">{{$article->keyword}}</textarea>
                            </div>
                        </div>    
                    </div>    
                </div>
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <upload-file-component
                                ...
                                input_file_name_value="{{ $article->image2 }}"
                                input_folder_name_value="{{ $article->folder }}"
                                file_uploaded="{{ $article->main_banner_file }}"
                            >
                            </upload-file-component>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <select class="form-control" name="category_id">
                                ...
                                @foreach($product_categories as $product_category)
                                    <option value="{{ $product_category['id'] }}" @php if($article->category_id == $product_category['id']) print "selected"; @endphp>{{ $product_category['name'] }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                <input type="text" name="publish_date" class="form-control datetimepicker-input" data-target="#reservationdate" value="{{ $article->publish_time }}"/>
                    ...
                    <div class="card card-secondary">
                        ...
                        <div class="card-body">
                            <div class="custom-control custom-checkbox">
                                <input class="custom-control-input" type="checkbox" name="hotnews" id="hotnews" value="1" @php print($article->hotnews?'checked':''); @endphp>
